...
class Sidebar(ctk.CTkFrame):
    def __init__(self, parent_app):
        ...
        self.play_numbers_game = ctk.CTkButton(self, text='Numbers Game', command=self.make_numbers_game)
        self.play_numbers_game.grid(row=2, column=0, padx=20, pady=10)
        self.play_letters_game = ctk.CTkButton(self, text='Letters Game', command=self.make_letters_game)
    ...
    def make_numbers_game(self):
        numbers_game = Numbers_Game()
        numbers_game.mainloop()

    def make_letters_game(self):
